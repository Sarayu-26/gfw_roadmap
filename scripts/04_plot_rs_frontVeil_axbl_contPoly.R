...
#
# Output:
#   outputs/figures/exploratory/species_threat_fronts_AquaXBirdlife_frontPolyCont_v01a.png
# =============================================================================
...
p4 <- ggplot2::ggplot() +
  ...
  scale_alpha(range = c(0, max_veil_alpha), guide = "none") +
...
ggplot2::ggsave(
  filename = "outputs/figures/exploratory/species_threat_fronts_AquaXBirdlife_frontPolyCont_v01a.png",
  plot = p4,
  width = 14,
  height = 7,
  units = "in",
